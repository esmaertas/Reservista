...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Anasayfa</a><i class="fa fa-angle-right"></i>Sorunları Yönet</li>
            </ol>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id);?>');">Görüntüle </a>
</td>
