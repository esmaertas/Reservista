...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Anasayfa</a><i class="fa fa-angle-right"></i>İstek Yönetimi</li>
            </ol>
					...
					<div class="w3l-table-info">
					  <h2>İstek Yönetimi</h2>
						...
						<thead>
						  ...
						  <th>İstek id</th>
							<th>Adı</th>
							<th>Telefon Numarası/ E-postası</th>
...
<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >Bekleme</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
