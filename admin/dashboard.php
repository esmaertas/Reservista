...
<!--header end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Anasayfa</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
