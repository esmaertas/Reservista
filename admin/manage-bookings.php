...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Anasayfa</a><i class="fa fa-angle-right"></i>Rezervasyonlar</li>
            </ol>
...
{
echo "İptal Etme Tarihi : " .$result->upddate;
} 
...
<?php if($result->status==2)
{
	?><td>İptal Edildi</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Rezervasyonu iptal etmek istediğinize emin misiniz ?')" >İptal</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Onaylıyor musunuz ? ')" >Onayla</a></td>
<?php }?>
